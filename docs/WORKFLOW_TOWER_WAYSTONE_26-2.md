...
> Este archivo pertenece al proyecto **Tower Waystone**. Cambios aquí solo afectan a este proyecto.
...
| Última versión publicada | `1.0.11` (CurseForge file ID 8677631) |
| Estado | ✅ Release estable 1.0.11 |

### Notas específicas de este mod

- **Rama 26.2**: `minecraft/26.2/neoforge-26.2.0.57/production` (+ `main` hermana). JAR: `tower_waystone-26.2-neoforge-<version>.jar`. Tags: `26.2-neoforge-<version>`.
