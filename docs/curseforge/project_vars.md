...
Ejemplo: `26.1.2-neoforge-1.0.18`
...
<p><strong>JAR</strong>: <code>tower_waystone-26.1.2-neoforge-1.0.X.jar</code></p>
```
...
with open(f"build/libs/tower_waystone-26.1.2-neoforge-{version}.jar", "rb") as f:
    jar_data = f.read()
