...
| Ejemplo | Significado |
|---------|-------------|
| `tower_waystone-1.21.1-neoforge-0.0.0-beta.2.jar` | NeoForge 1.21.1, beta 2 |
| `tower_waystone-1.21.1-neoforge-1.0.0.jar` | NeoForge 1.21.1, release 1.0.0 |
| `tower_waystone-26.1.2-neoforge-0.0.0-beta.14.jar` | NeoForge 26.1.2, beta 14 |
