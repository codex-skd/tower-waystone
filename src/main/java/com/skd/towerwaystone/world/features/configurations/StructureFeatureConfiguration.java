package com.skd.towerwaystone.world.features.configurations;
...
public record StructureFeatureConfiguration(
        ...
        HolderSet<Block> ignoredBlocks,
        Vec3i offset) implements FeatureConfiguration {
    ...
    public static final Codec<StructureFeatureConfiguration> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    ...
                    Codec.BOOL.optionalFieldOf("random_rotation", false).forGetter(StructureFeatureConfiguration::randomRotation),
                    Codec.BOOL.optionalFieldOf("random_mirror", false).forGetter(StructureFeatureConfiguration::randomMirror),
