# Graph Report - 26.2  (2026-08-16)

## Corpus Check
- 82 files · ~75,400 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 248 nodes · 311 edges · 72 communities (37 shown, 35 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6a588c64`
...
1. `Registro de cambios` - 46 edges
...
Cohesion: 0.30
Nodes (8): Entry, Post, ServerLevel, BlockPos, Load, SubscribeEvent, PendingWaystone, WaystoneNamer

### Community 1 - "WaystoneTowersMod.java"
Cohesion: 0.22
Nodes (7): FMLClientSetupEvent, CustomDimensionConfig, IEventBus, Mod, Logger, TowerWaystone, WaystoneBeaconRenderer

### Community 2 - "gradlew"
Cohesion: 0.25
Nodes (6): Gson, Logger, Settings, WaystoneBeaconConfig, SubscribeEvent, SubmitCustomGeometryEvent

### Community 4 - "settings.gradle"
Cohesion: 0.29
Nodes (6): ClientTickEvent, BlockPos, Load, SubscribeEvent, WaystoneBeaconClientData, Unload
...
Cohesion: 0.15
Nodes (12): 0.0.0-beta.5 — 2026-07-28, 1.0.6 — 2026-07-08, 1.0.7 — 2026-07-08, [1.0.8] - 2026-08-16, 1.0.9 — 2026-07-08, Added, Cambiado, Corregido (+4 more)

## Knowledge Gaps
- **85 isolated node(s):** `Workflow del mod`, `Prioridad de instrucciones`, `Fixed`, `Fixed`, `Added` (+80 more)
