...
6. `WaystoneNamer` - 7 edges
7. `Custom Dimensions — Tower Waystone` - 7 edges
8. `CustomDimensionConfig` - 5 edges
9. `PendingWaystone` - 5 edges
10. `Tower Waystone` - 5 edges
...
Cohesion: 0.24
Nodes (6): CustomDimensionConfig, Gson, IEventBus, Mod, Logger, TowerWaystone
